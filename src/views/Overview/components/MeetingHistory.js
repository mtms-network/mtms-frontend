...
import { BrandLogoLoading, GroupLayout, GroupTitle, Input, Pagination, Collapser } from "components";
      ...
      <GroupLayout className="flex flex-col w-full">
        ...
        <div className="flex flex-row justify-between w-full mb-3">
          ...
          <div className="flex-1 space-x-2 flex flex-row w-auto items-center justify-end">
            <button>
              <IoFilterCircle className="text-black" onClick={() => { setIsShowFilter(!isShowFilter); }} />
            </button>
            <button>
